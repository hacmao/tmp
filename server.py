...
[****] Challenge : Simple math - You must answer 317 questions to get flag.  
...
def random_math() : 
    ...
    return challenge, text2art(challenge).encode()
...
class ThreadedTCPRequestHandler(SocketServer.BaseRequestHandler):
	def handle(self):
		...
		for i in range(317) : 
			challenge, art = random_math()
			self.request.sendall(b"[*] Challenge %i : \n%s \n   > Answer : " % (i + 1, art)) 
